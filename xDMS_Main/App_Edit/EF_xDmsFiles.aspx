      ...
      <asp:UpdatePanel ID="UPNLxDmsFiles" runat="server">
        <ContentTemplate>
          ...
          <asp:FormView ID="FVxDmsFiles"
            ...
            <EditItemTemplate>
              <div id="frmdiv" class="ui-widget-content minipage" style="height:400px; overflow-y: scroll;">
                <table style="margin: auto; border: solid 1pt lightgrey">
                  <tr>
                    <td class="alignright">
                      <b>
                        <asp:Label ID="L_FileID" runat="server" ForeColor="#CC6633" Text="File ID :" /><span style="color: red">*</span></b>
                    </td>
                    <td>
