...
Partial Class EF_xDmsFolderAuthorizations
  ...
  Public Property PrimaryKey() As String
    ...
    End Set
  End Property
  Protected Sub ODSxDmsFolderAuthorizations_Selected(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ODSxDmsFolderAuthorizations.Selected
    Dim tmp As SIS.xDMS.xDmsFolderAuthorizations = CType(e.ReturnValue, SIS.xDMS.xDmsFolderAuthorizations)
  ...
  Protected Sub FVxDmsFolderAuthorizations_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles FVxDmsFolderAuthorizations.Init
    DataClassName = "ExDmsFolderAuthorizations"
  ...
  Protected Sub FVxDmsFolderAuthorizations_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles FVxDmsFolderAuthorizations.PreRender
    TBLxDmsFolderAuthorizations.EnableSave = Editable
    TBLxDmsFolderAuthorizations.EnableDelete = Deleteable
    Dim mStr As String = ""
    Dim oTR As IO.StreamReader = New IO.StreamReader(HttpContext.Current.Server.MapPath("~/xDMS_Main/App_Edit") & "/EF_xDmsFolderAuthorizations.js")
    mStr = oTR.ReadToEnd
    oTR.Close()
    oTR.Dispose()
