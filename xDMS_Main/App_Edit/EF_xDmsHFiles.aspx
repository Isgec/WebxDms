<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EF_xDmsHFiles.aspx.vb" Inherits="EF_xDmsHFiles" title="Edit: Files History" %>
<asp:Content ID="CPHxDmsHFiles" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelxDmsHFiles" runat="server" Text="&nbsp;Edit: Files History"></asp:Label>
</div>
...
<asp:FormView ID="FVxDmsHFiles"
  ...
  <EditItemTemplate>
    ...
    <table style="margin:auto;border: solid 1pt lightgrey">
      <tr>
        <td class="alignright">
          <b><asp:Label ID="L_FileID" runat="server" ForeColor="#CC6633" Text="FileID :" /><span style="color:red">*</span></b>
        </td>
        <td>
          <asp:TextBox ID="F_FileID"
            Text='<%# Bind("FileID") %>'
            ToolTip="Value of FileID."
            Enabled = "False"
            CssClass = "mypktxt"
            Width="88px"
        ...
        <td class="alignright">
          <b><asp:Label ID="L_HFileID" runat="server" ForeColor="#CC6633" Text="HFileID :" /><span style="color:red">*</span></b>
        </td>
        <td>
          <asp:TextBox ID="F_HFileID"
            Text='<%# Bind("HFileID") %>'
            ToolTip="Value of HFileID."
            Enabled = "False"
            CssClass = "mypktxt"
            Width="88px"
            style="text-align: right"
...
<asp:ObjectDataSource 
  ...
  SelectMethod = "xDmsHFilesGetByID"
  UpdateMethod="xDmsHFilesUpdate"
  DeleteMethod="xDmsHFilesDelete"
...
<SelectParameters>
  ...
  <asp:QueryStringParameter DefaultValue="0" QueryStringField="HFileID" Name="HFileID" Type="Int32" />
</SelectParameters>
</asp:ObjectDataSource>
</div>
</div>
