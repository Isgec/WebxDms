...
Partial Class GF_xDmsGroupUsers
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/xDMS_Main/App_Display/DF_xDmsGroupUsers.aspx"
  ...
  Protected Sub GVxDmsGroupUsers_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVxDmsGroupUsers.Init
    DataClassName = "GxDmsGroupUsers"
    SetGridView = GVxDmsGroupUsers
  End Sub
