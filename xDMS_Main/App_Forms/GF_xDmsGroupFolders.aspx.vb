...
Partial Class GF_xDmsGroupFolders
  Inherits SIS.SYS.GridBase
  Private _InfoUrl As String = "~/xDMS_Main/App_Display/DF_xDmsGroupFolders.aspx"
  Protected Sub Info_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
    Dim oBut As ImageButton = CType(sender, ImageButton)
    Dim aVal() As String = oBut.CommandArgument.ToString.Split(",".ToCharArray)
    Dim RedirectUrl As String = _InfoUrl  & "?GroupID=" & aVal(0) & "&FolderID=" & aVal(1)
  ...
  Protected Sub GVxDmsGroupFolders_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles GVxDmsGroupFolders.Init
    DataClassName = "GxDmsGroupFolders"
    SetGridView = GVxDmsGroupFolders
  End Sub
  ...
  Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Dim validateScriptGroupID As String = "<script type=""text/javascript"">" & _
      ...
      "    validated_FK_xDMS_GroupFolders_GroupID_main = true;" & _
      "    validate_FK_xDMS_GroupFolders_GroupID(o);" & _
      "  }" & _
      "</script>"
    ...
    End If
    Dim validateScriptFK_xDMS_GroupFolders_GroupID As String = "<script type=""text/javascript"">" & _
      "  function validate_FK_xDMS_GroupFolders_GroupID(o) {" & _
      "    var value = o.id;" & _
      "    var GroupID = $get('" & F_GroupID.ClientID & "');" & _
      "    try{" & _
      "    if(GroupID.value==''){" & _
      "      if(validated_FK_xDMS_GroupFolders_GroupID.main){" & _
      ...
      "    PageMethods.validate_FK_xDMS_GroupFolders_GroupID(value, validated_FK_xDMS_GroupFolders_GroupID);" & _
      "  }" & _
      "  validated_FK_xDMS_GroupFolders_GroupID_main = false;" & _
      "  function validated_FK_xDMS_GroupFolders_GroupID(result) {" & _
      ...
      "  }" & _
      "</script>"
    If Not Page.ClientScript.IsClientScriptBlockRegistered("validateFK_xDMS_GroupFolders_GroupID") Then
      Page.ClientScript.RegisterClientScriptBlock(GetType(System.String), "validateFK_xDMS_GroupFolders_GroupID", validateScriptFK_xDMS_GroupFolders_GroupID)
    End If
  End Sub
  <System.Web.Services.WebMethod()> _
