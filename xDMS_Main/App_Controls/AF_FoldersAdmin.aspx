<%@ Page Language="VB" MasterPageFile="~/PlaneMaster.master" AutoEventWireup="false" ClientIDMode="Static" CodeFile="AF_FoldersAdmin.aspx.vb" Inherits="AF_FoldersAdmin" %>
<asp:Content ID="CPHxDmsFolders" ContentPlaceHolderID="cph1" runat="Server">
  ...
  <script>
    parent.lgMessageBox.resizeFrame(552,259);
  </script>
</asp:Content>
