...
var script_xDmsFGroups = {
    ...
    validate_ReleaseWorkflowID: function(sender) {
      ...
      this.validated_FK_xDMS_FGroups_ReleaseWorkflowID_main = true;
      this.validate_FK_xDMS_FGroups_ReleaseWorkflowID(sender,Prefix);
      },
    validate_ReviseWorkflowID: function(sender) {
      var Prefix = sender.id.replace('ReviseWorkflowID','');
      this.validated_FK_xDMS_FGroups_ReviseWorkflowID_main = true;
      this.validate_FK_xDMS_FGroups_ReviseWorkflowID(sender,Prefix);
      },
    validate_FK_xDMS_FGroups_ReleaseWorkflowID: function(o,Prefix) {
      var value = o.id;
      var ReleaseWorkflowID = $get(Prefix + 'ReleaseWorkflowID');
      if(ReleaseWorkflowID.value==''){
        if(this.validated_FK_xDMS_FGroups_ReleaseWorkflowID_main){
      ...
      value = value + ',' + ReleaseWorkflowID.value ;
        ...
        PageMethods.validate_FK_xDMS_FGroups_ReleaseWorkflowID(value, this.validated_FK_xDMS_FGroups_ReleaseWorkflowID);
      },
    validated_FK_xDMS_FGroups_ReleaseWorkflowID_main: false,
    validated_FK_xDMS_FGroups_ReleaseWorkflowID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_xDmsFGroups.validated_FK_xDMS_FGroups_ReleaseWorkflowID_main){
    ...
    validate_FK_xDMS_FGroups_ReviseWorkflowID: function(o,Prefix) {
      var value = o.id;
      var ReviseWorkflowID = $get(Prefix + 'ReviseWorkflowID');
      if(ReviseWorkflowID.value==''){
        if(this.validated_FK_xDMS_FGroups_ReviseWorkflowID_main){
      ...
      value = value + ',' + ReviseWorkflowID.value ;
        ...
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_xDMS_FGroups_ReviseWorkflowID(value, this.validated_FK_xDMS_FGroups_ReviseWorkflowID);
      },
    validated_FK_xDMS_FGroups_ReviseWorkflowID_main: false,
    validated_FK_xDMS_FGroups_ReviseWorkflowID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_xDmsFGroups.validated_FK_xDMS_FGroups_ReviseWorkflowID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
