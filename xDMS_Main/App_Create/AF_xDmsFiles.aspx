<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_xDmsFiles.aspx.vb" Inherits="AF_xDmsFiles" title="Add: DMS Files" %>
<asp:Content ID="CPHxDmsFiles" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelxDmsFiles" runat="server" Text="&nbsp;Add: DMS Files"></asp:Label>
</div>
...
<asp:FormView ID="FVxDmsFiles"
  ...
  <InsertItemTemplate>
    ...
    <asp:Label ID="L_ErrMsgxDmsFiles" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
    <table style="margin:auto;border: solid 1pt lightgrey">
      <tr>
        ...
        <td>
          <asp:TextBox ID="F_FileID" Enabled="False" CssClass="mypktxt" Width="88px" runat="server" Text="0" />
        </td>
        <td class="alignright">
...
<asp:ObjectDataSource 
  ...
  InsertMethod="UZ_xDmsFilesInsert"
