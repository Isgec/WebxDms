...
var script_xDmsFolders = {
    ...
    validate_FolderName: function(o,p) {                                                                     
      var value = o.id;                                                                                         
    ...
    validated_FolderName: function(result) {                                                               
      ...
      if(p[0]=='1'){                                                                                            
        ...
        //var oj = eval('(' + p[2] + ')');
        //$get('F_KeyWords').value=oj.KeyWords;
        //$get('F_ReleaseWorkflowID').value=oj.ReleaseWorkflowID;
        //$get('F_ReleaseWorkflowID_Display').innerText=oj.xDMS_Workflows5_WorkflowName;
        //$get('F_ReviseWorkflowID').innerText=oj.ReviseWorkflowID;
        //$get('F_ReviseWorkflowID_Display').value=oj.xDMS_Workflows6_WorkflowName;
        //$get('F_InitialWorkflowID').value=oj.InitialWorkflowID;
        //$get('F_InitialWorkflowID_Display').value=oj.xDMS_Workflows8_WorkflowName;
        //$get('F_UploadedStatusID').value=oj.UploadedStatusID;
        //$get('F_UploadedStatusID_Display').value=oj.xDMS_States7_StatusName;
        //$get('F_UseFileTypeWorkflow').value=oj.UseFileTypeWorkflow;
        //$get('F_RequireExplicitAuthorization').value=oj.RequireExplicitAuthorization;
