<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_xDmsFolderAuthorizations.aspx.vb" Inherits="AF_xDmsFolderAuthorizations" title="Add: DMS Folder Authorizations" %>
<asp:Content ID="CPHxDmsFolderAuthorizations" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelxDmsFolderAuthorizations" runat="server" Text="&nbsp;Add: DMS Folder Authorizations"></asp:Label>
</div>
      ...
      <tr>
        ...
        <td colspan="3">
          <asp:TextBox
            ...
            ValidationGroup = "xDmsFolderAuthorizations"
            onblur= "script_xDmsFolderAuthorizations.validate_FolderID(this);"
            Runat="Server" />
          <asp:RequiredFieldValidator 
            ID = "RFVFolderID"
            runat = "server"
          ...
          <AJX:AutoCompleteExtender
            ...
            FirstRowSelected="true"
            MinimumPrefixLength="1"
            OnClientItemSelected="script_xDmsFolderAuthorizations.ACEFolderID_Selected"
            OnClientPopulating="script_xDmsFolderAuthorizations.ACEFolderID_Populating"
            OnClientPopulated="script_xDmsFolderAuthorizations.ACEFolderID_Populated"
            CompletionSetCount="10"
            CompletionListCssClass = "autocomplete_completionListElement"
            CompletionListItemCssClass = "autocomplete_listItem"
            CompletionListHighlightedItemCssClass = "autocomplete_highlightedListItem"
