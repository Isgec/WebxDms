...
var script_xDmsFileAuthorizations = {
    ...
    validate_UserID: function(sender) {
      ...
      this.validated_FK_xDMS_FileAuthorizations_UserID_main = true;
      this.validate_FK_xDMS_FileAuthorizations_UserID(sender,Prefix);
      },
    validate_FileID: function(sender) {
      var Prefix = sender.id.replace('FileID','');
      this.validated_FK_xDMS_FileAuthorizations_FileID_main = true;
      this.validate_FK_xDMS_FileAuthorizations_FileID(sender,Prefix);
      },
    ...
    validate_FK_xDMS_FileAuthorizations_UserID: function(o,Prefix) {
      var value = o.id;
      var UserID = $get(Prefix + 'UserID');
      if(UserID.value==''){
        if(this.validated_FK_xDMS_FileAuthorizations_UserID_main){
      ...
      value = value + ',' + UserID.value ;
        ...
        PageMethods.validate_FK_xDMS_FileAuthorizations_UserID(value, this.validated_FK_xDMS_FileAuthorizations_UserID);
      },
    validated_FK_xDMS_FileAuthorizations_UserID_main: false,
    validated_FK_xDMS_FileAuthorizations_UserID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_xDmsFileAuthorizations.validated_FK_xDMS_FileAuthorizations_UserID_main){
    ...
    validate_FK_xDMS_FileAuthorizations_FileID: function(o,Prefix) {
      var value = o.id;
      var FileID = $get(Prefix + 'FileID');
      if(FileID.value==''){
        if(this.validated_FK_xDMS_FileAuthorizations_FileID_main){
          var o_d = $get(Prefix + 'FileID' + '_Display');
          try{o_d.innerHTML = '';}catch(ex){}
        }
        return true;
      }
      value = value + ',' + FileID.value ;
        o.style.backgroundImage  = 'url(../../images/pkloader.gif)';
        o.style.backgroundRepeat= 'no-repeat';
        o.style.backgroundPosition = 'right';
        PageMethods.validate_FK_xDMS_FileAuthorizations_FileID(value, this.validated_FK_xDMS_FileAuthorizations_FileID);
      },
    validated_FK_xDMS_FileAuthorizations_FileID_main: false,
    validated_FK_xDMS_FileAuthorizations_FileID: function(result) {
      var p = result.split('|');
      var o = $get(p[1]);
      if(script_xDmsFileAuthorizations.validated_FK_xDMS_FileAuthorizations_FileID_main){
        var o_d = $get(p[1]+'_Display');
        try{o_d.innerHTML = p[2];}catch(ex){}
      }
      o.style.backgroundImage  = 'none';
