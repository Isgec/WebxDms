<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="AF_xDmsFolders.aspx.vb" Inherits="AF_xDmsFolders" title="Add: DMS Folders" %>
<asp:Content ID="CPHxDmsFolders" ContentPlaceHolderID="cph1" Runat="Server">
<div id="div1" class="ui-widget-content page">
<div id="div2" class="caption">
    <asp:Label ID="LabelxDmsFolders" runat="server" Text="&nbsp;Add: DMS Folders"></asp:Label>
</div>
...
<asp:FormView ID="FVxDmsFolders"
  ...
  <InsertItemTemplate>
    ...
    <asp:Label ID="L_ErrMsgxDmsFolders" runat="server" ForeColor="Red" Font-Bold="true" Text=""></asp:Label>
    <table style="margin:auto;border: solid 1pt lightgrey">
      <tr>
        ...
        <td colspan="3">
          <asp:TextBox ID="F_FolderID" Enabled="False" CssClass="mypktxt" Width="88px" runat="server" Text="0" />
        </td>
      </tr>
      <tr>
        <td class="alignright">
