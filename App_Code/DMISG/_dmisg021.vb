...
Namespace SIS.DMISG
  ...
  Partial Public Class dmisg021
    ...
    End Class
    '1. Used
    Public Shared Function Getdmisg021(ByVal docn As String, ByVal revn As String, Optional Comp As String = "200") As List(Of SIS.DMISG.dmisg021)
      Dim tmp As New List(Of SIS.DMISG.dmisg021)
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetBaaNConnectionString())
        Con.Open()
        Using Cmd As SqlCommand = Con.CreateCommand()
          Cmd.CommandType = CommandType.Text
          Cmd.CommandText = "Select * from tdmisg021" & Comp & " where t_docn = '" & docn & "' and t_revn='" & revn & "' order by t_srno"
          Dim rd As SqlDataReader = Cmd.ExecuteReader
          While rd.Read
            tmp.Add(New SIS.DMISG.dmisg021(rd))
          End While
        End Using
      End Using
      Return tmp
