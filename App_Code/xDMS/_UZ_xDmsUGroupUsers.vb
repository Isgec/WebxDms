...
Namespace SIS.xDMS
  Partial Public Class xDmsUGroupUsers
    ...
    Public ReadOnly Property DeleteWFEnable() As Boolean
      ...
      End Get
    End Property
    Public Shared Function DeleteWF(ByVal GroupID As Int32, ByVal UserID As String) As SIS.xDMS.xDmsUGroupUsers
      Dim Results As SIS.xDMS.xDmsUGroupUsers = xDmsUGroupUsersGetByID(GroupID, UserID)
      Return Results
    End Function
    ...
    Public ReadOnly Property ApplyWFEnable() As Boolean
      ...
      End Get
    End Property
    Public Shared Function ApplyWF(ByVal GroupID As Int32, ByVal UserID As String) As SIS.xDMS.xDmsUGroupUsers
      Dim Results As SIS.xDMS.xDmsUGroupUsers = xDmsUGroupUsersGetByID(GroupID, UserID)
      Return Results
    End Function
    ...
    Public ReadOnly Property InitiateWFEnable() As Boolean
      ...
      End Get
    End Property
    Public Shared Function InitiateWF(ByVal GroupID As Int32, ByVal UserID As String) As SIS.xDMS.xDmsUGroupUsers
      Dim Results As SIS.xDMS.xDmsUGroupUsers = xDmsUGroupUsersGetByID(GroupID, UserID)
      Return Results
    End Function
