...
<%@ WebHandler Language="VB" Class="dmsCheckin"  %>
...
Imports ejiVault
Public Class dmsCheckin : Implements IHttpHandler, IRequiresSessionState
      ...
      If context.Request.Files.Count > 0 Then
        ...
        If EJI.DBCommon.ConnectLibrary() Then
          ...
          For I = 0 To context.Request.Files.Count - 1
            ...
            Dim dmsFile As SIS.xDMS.xDmsFiles = SIS.xDMS.xDmsFiles.xDmsFilesGetByID(keyTarget)
            With dmsFile
            ...
            '========================
            SIS.xDMS.xDmsHFiles.CreateHistory(dmsFile.FileID, "Checked In", True)
            '==========================
          Next
        ...
        For I = 0 To context.Request.Files.Count - 1
          ...
          If fu.ContentLength > 0 AndAlso fileName <> "" Then
            ...
            With dmsFile
              ...
              .StatusBy = xUser.UserID
              .StatusOn = Now
              .StatusRemarks = "Uploaded by user"
              .VaultDRID = ""
            End With
