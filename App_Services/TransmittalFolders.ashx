<%@ WebHandler Language="VB" Class="TransmittalFolders" %>
...
Public Class TransmittalFolders : Implements IHttpHandler, IRequiresSessionState
  ...
  Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
    ...
    For Each key As String In context.Request.Form.AllKeys
      If key.IndexOf("ProjectID") >= 0 Then
        ProjectID = context.Request.Form(key)
      End If
    ...
    Else
      Try
        ...
        SIS.xDMS.cDmsERPMapping.CreateFoldersForTransmittal(ProjectID, Comp)
