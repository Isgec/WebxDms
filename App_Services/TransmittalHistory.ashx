<%@ WebHandler Language="VB" Class="TransmittalHistory" %>
...
Public Class TransmittalHistory : Implements IHttpHandler, IRequiresSessionState
  ...
  Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
    ...
    Else
      Try
        ...
        SIS.xDMS.xDmsHFiles.CreateHistory(MainFileID, "Issued")
